package know.studio.auth.infra.persistence;

import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import know.studio.auth.api.SystemRole;
import know.studio.auth.api.TeamRole;
import know.studio.auth.domain.IdentityRepository;
import know.studio.auth.domain.UserAccount;
import know.studio.auth.domain.UserStatus;
import know.studio.auth.domain.Team;
import know.studio.auth.domain.TeamAccess;
import know.studio.auth.domain.TeamMember;
import know.studio.auth.domain.TeamStatus;
import know.studio.auth.infra.persistence.entity.TeamEntity;
...
import know.studio.auth.infra.persistence.mapper.UserMapper;
import know.studio.auth.infra.persistence.mapper.TeamMapper;
import know.studio.auth.infra.persistence.mapper.TeamMemberMapper;
