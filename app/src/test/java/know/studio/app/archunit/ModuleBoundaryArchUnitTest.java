package know.studio.app.archunit;
...
class ModuleBoundaryArchUnitTest {
    ...
    private static final String ROOT_PACKAGE = "know.studio";
    private static final List<String> PLATFORM_MODULES = List.of("common", "ai");
    ...
    void platformModulesMustNotDependOnBusinessModules() {
        ArchRule rule = classes()
                .that().resideInAnyPackage(platformPackagePatterns())
    ...
    private static String[] platformPackagePatterns() {
        return PLATFORM_MODULES.stream()
                .map(module -> ROOT_PACKAGE + "." + module + "..")
                .toArray(String[]::new);
    }
