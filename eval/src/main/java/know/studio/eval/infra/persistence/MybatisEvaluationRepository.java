package know.studio.eval.infra.persistence;

import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import know.studio.eval.domain.EvaluationDataset;
import know.studio.eval.domain.EvaluationRepository;
import know.studio.eval.domain.EvaluationRun;
import know.studio.eval.domain.EvaluationSample;
...
import know.studio.eval.infra.persistence.mapper.EvaluationDatasetMapper;
import know.studio.eval.infra.persistence.mapper.EvaluationRunMapper;
import know.studio.eval.infra.persistence.mapper.EvaluationSampleMapper;
...
public class MybatisEvaluationRepository implements EvaluationRepository {
    ...
    private EvaluationRun toDomain(EvaluationRunEntity entity) {
        return new EvaluationRun(
                ...
                entity.getDatasetId(),
                entity.getUserId(),
                know.studio.search.api.RetrievalMode.valueOf(entity.getConfig()),
