...
这套文件用于两台 `3.3G` 级别 Linux 服务器的拆分部署，**不会覆盖根目录现有的完整** [docker-compose.yml](/E:/AICode/know-studio/docker-compose.yml)。
...
```bash
cd /opt/know-studio/deploy/two-node
